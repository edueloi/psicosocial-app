...
const navLabels: Record<UserPreferences['language'], Record<string, string>> = {
  'pt-BR': { dashboard: 'Dashboard', inventory: 'Gestão de Riscos', actions: 'Plano de Ação', psychosocial: 'Psicossocial', audit: 'Status Auditoria', timeline: 'Timeline NR-01', users: 'Usuários', units: 'Unidades', forms: 'Forms Externos', operations: 'Operação Mensal', documents: 'Documentos', permissions: 'Permissões', reports: 'Relatórios PGR', manual: 'Manual do Sistema' },
  'en-US': { dashboard: 'Dashboard', inventory: 'Risk Management', actions: 'Action Plan', psychosocial: 'Psychosocial', audit: 'Audit Status', timeline: 'NR-01 Timeline', users: 'Users', units: 'Units', forms: 'External Forms', operations: 'Monthly Operations', documents: 'Documents', permissions: 'Permissions', reports: 'PGR Reports', manual: 'System Manual' },
  'es-ES': { dashboard: 'Panel', inventory: 'Gestión de Riesgos', actions: 'Plan de Acción', psychosocial: 'Psicosocial', audit: 'Estado de Auditoría', timeline: 'Línea de tiempo NR-01', users: 'Usuarios', units: 'Unidades', forms: 'Formularios Externos', operations: 'Operación Mensual', documents: 'Documentos', permissions: 'Permisos', reports: 'Reportes PGR', manual: 'Manual del Sistema' },
};
