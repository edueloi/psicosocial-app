...
import { LayoutDashboard, ShieldAlert, ClipboardList, Users, FileText, BrainCircuit, Building2, History, ShieldCheck, FileSpreadsheet, ClipboardCheck, Shield, FolderOpen, BookOpenText } from 'lucide-react';
...
export const NAV_ITEMS = [
  ...
  { id: 'manual', label: 'Manual do Sistema', icon: <BookOpenText size={20} />, roles: [UserRole.TENANT_ADMIN, UserRole.SST_CONSULTANT, UserRole.RH_MANAGER, UserRole.SUPER_ADMIN, UserRole.AUDITOR, UserRole.EMPLOYEE] },
];
